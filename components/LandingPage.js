    ...
    render() {
      return (
        <React.Fragment>
          ...
          <Section backgroundColor={"#fafaf4"} alignItems={"center"} padding={"5rem 10rem"}>
            <Text
              fontSize={"1.6rem"}
              // padding={" 1rem 0"}
              style={{letterSpacing: '1px'}}
            ...
            <Text
              ...
              fontWeight={"300"}
              color={color.textLight}>
              We've launched with features others have ignored, and we're just getting started.
            </Text>
            <Section flexDirection={"row"} justifyContent={"space-between"} padding={"5rem 0rem"}>
              <Section justifyContent={"center"} alignItems={"center"} margin={"0 4rem 0 0"}>
                <IconHolder width={"60px"} height={"60px"} src={"/static/images/Parachute.svg"} margin={"auto"}/>
                <Text
                  fontSize={"2rem"}
                  padding={" 1rem 0"}
                  fontWeight={"300"}
                ...
                <Text
                  ...
                  fontWeight={"300"}
                  color={color.textLight}>
                  A clean, easy to use calendar for scheduling all your clients & their owners.
                </Text>
              </Section>
              <Section justifyContent={"center"} alignItems={"center"} margin={"0 4rem 0 0"}>
                <IconHolder width={"60px"} height={"60px"} src={"/static/images/Prizemedalion.svg"} margin={"auto"}/>
                <Text
                  fontSize={"2rem"}
                  padding={" 1rem 0"}
                  fontWeight={"300"}
                ...
                <Text
                  ...
                  fontWeight={"300"}
                  color={color.textLight}>
                  Your digital Client Record Cards. Keep track of Owners & their pets, no fuss.
                </Text>
              </Section>
              <Section justifyContent={"center"} alignItems={"center"}>
                <IconHolder width={"60px"} height={"60px"} src={"/static/images/Umbrella.svg"} margin={"auto"}/>
                <Text
                  fontSize={"2rem"}
                  padding={" 1rem 0"}
                  fontWeight={"300"}
                ...
                <Text
                  ...
                  fontWeight={"300"}
                  color={color.textLight}>
                  View your Appointments in Google Calendar & your Google Events in our Calendar.
                </Text>
              </Section>
            </Section>
            <Section flexDirection={"row"} justifyContent={"space-between"} padding={"5rem 0rem"}>
              <Section justifyContent={"center"} alignItems={"center"} margin={"0 4rem 0 0"}>
                ...
                <Text
                  ...
                  fontWeight={"300"}
                  color={color.textLight}>
                  % of Appointment? Done! Dollar Amount? No problem. How about when they no show? Forfeit or Return.. you decide!
                </Text>
              </Section>
              <Section justifyContent={"center"} alignItems={"center"} margin={"0 4rem 0 0"}>
                <IconHolder width={"60px"} height={"60px"} src={"/static/images/Prizemedalion.svg"} margin={"auto"}/>
                ...
                <Text
                  ...
                  fontWeight={"300"}
                  color={color.textLight}>
                  Don't settle for Generic. Booking require your approval? Sure. New Customer 100% deposit? We got you.
                </Text>
              </Section>
              <Section justifyContent={"center"} alignItems={"center"}>
                <IconHolder width={"60px"} height={"60px"} src={"/static/images/Umbrella.svg"} margin={"auto"}/>
                ...
                <Text
                  ...
                  fontWeight={"300"}
                  color={color.textLight}>
                  Reduce No-Shows and Increase Customer Satisfaction with SMS & Email Reminders. Easy.
                </Text>
              </Section>
            </Section>
          </Section>

          <Section withImage padding={"5rem 10rem 0rem 10rem"} src={"/static/images/appetments_banner.jpg"} backgroundSize={"cover"} alignItems={"center"}>
            <Text
              fontSize={"2.2rem"}
              fontWeight={"200"}
              padding={"0 0 4rem 0"}
